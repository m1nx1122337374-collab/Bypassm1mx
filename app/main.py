...
<title>Online</title><style>
:root{color-scheme:dark}html,body{height:100%;margin:0}body{display:grid;place-items:center;background:#0b1020;color:#78e0ac;font:700 22px system-ui,sans-serif}main{text-align:center}h1{margin:0;font-size:clamp(34px,8vw,64px);letter-spacing:.04em}p{margin:12px 0 0;color:#9ba9c8;font-size:14px;font-weight:500}
</style></head><body><main><h1>Online</h1><p>Authorized URL Resolver</p></main></body></html>"""
